...
export const CommandPalette = ({ isOpen, onClose, onNavigate, onSelectProduct }: CommandPaletteProps) => {
  ...
  }, [inventory, role, onNavigate, onClose, onSelectProduct]);
              ...
              {filteredCommands.map((cmd, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-left group ${isSelected
                  ...
                  >
                    ...
                    {isSelected && (
                      <kbd className="px-2 py-1 bg-slate-200 dark:bg-slate-600 rounded text-[10px] font-mono text-slate-500 dark:text-slate-300 animate-fade-in">
                        Enter
                      </kbd>
                    )}
                  </button>
